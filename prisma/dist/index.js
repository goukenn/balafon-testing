...
(function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, db_1.default.tbprisma_authors.findMany({
                        // select:{ 
                        //     clFirstName: true
                        //     // _count: {
                        //     //     select:{
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, db_1.default.tbprisma_tablename.create({
                            data: {
                                clName: 'IOS_jump'
                            }
                        })];
                ...
                case 4:
                    _a = _b.sent();
                    return [3 /*break*/, 5];
                case 5: return [4 /*yield*/, db_1.default.tbprisma_authors.createMany({
                        data: [
