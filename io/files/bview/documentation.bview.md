...
Les attributs HTML/SVG sont placés entre crochets `[]` avec le séparateur `:`.
...
/* Sans espaces avant/après les deux-points */
div[class:active, id:main]
```

### Attributs vides

Si aucun attribut n'est nécessaire, utilisez des crochets vides ou omettez-les:
...
```bview
// @description Page de gestion des credentials
