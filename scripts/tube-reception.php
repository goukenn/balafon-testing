...
// @filename: tube-reception.php
// @date: 20250905 11:39:56
// @desc: script to handle tube command 
// @command: balafon --run .test/scripts/tube-reception.php
// @balafon-command: tube
// @balafon-example: balafon --find '.test/' '\.php$' | balafon --run tube
